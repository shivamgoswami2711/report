	...
	<div class="notice rm-notice welcome-panel plugin-card-seo-by-rank-math" id="try-rankmath-panel" style="clear:both;">
		<div class="welcome-panel-content" style="overflow:hidden;">
			...
			<div style="position: relative;">
				<h2><?php printf( __( 'Rank Math SEO plugin is recommended with %s theme!', 'mythemeshop' ), '<strong>' . esc_attr( $theme_name ) . '</strong>' ); ?></h2>
				...
				<ul>
					...
					<li>
						<i class="dashicons dashicons-yes"></i> <?php esc_html_e( '15+ Rich Snippets aka Schema Types', 'mythemeshop' ); ?>
					</li>
					<li>
