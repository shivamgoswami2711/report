		...
		protected function get_plugin_source_type_text( $type ) {
			...
			switch ( $type ) {
				case 'repo':
					...
					break;
				case 'external':
					$string = __( 'MyThemeShop', 'mythemeshop' );
					break;
				case 'bundled':
					...
					public function add_strings() {
						if ( 'update' === $this->options['install_type'] ) {
							...
							if ( $this->tgmpa->is_automatic ) {
								...
								$this->upgrader->strings['skin_update_successful']    = __( '%1$s installed and activated successfully.', 'mythemeshop' );
								...
								$this->upgrader->strings['skin_update_successful']    = esc_html__( '%1$s installed successfully.', 'mythemeshop' );
...
function mts_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				...
				'description' => __( 'We created <a href="https://rankmath.com/wordpress/plugin/seo-suite/" target="_blank">Rank Math, a WordPress SEO plugin</a>, to help every website owner get access to the SEO tools they need to improve their SEO and attract more traffic to their website.', 'mythemeshop' ),
				'required'    => false,
				'tab'         => 'both',
			),
