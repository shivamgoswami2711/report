...
class MTS_RMU {
	...
	private function __construct( $config = array() ) {
		$config_defaults = array(
			...
			'theme_options_notice'    => '<span style="display:block;line-height:1.8;margin-bottom:20px;padding-left:3%;margin-top:-40px;">' . sprintf( __( '%1$s is a revolutionary SEO product that combines the features of many SEO tools. Its features give you the power of an entire SEO team with just a few clicks.', 'mythemeshop' ), '<a href="https://rankmath.com/wordpress/plugin/seo-suite/" target="_blank">Rank Math SEO</a>' ) . ' @CTA' . '</span>',
			...
			'metabox_notice_install'  => sprintf( __( 'The new %1$s plugin will help you rank better in the search results.', 'mythemeshop' ), '<a href="https://rankmath.com/wordpress/plugin/seo-suite/" target="_blank">Rank Math SEO</a>' ) . ' @CTA',

			/* Translators: %s is CTA, e.g. "Try it now!" */
			'metabox_notice_activate' => sprintf( __( 'The %1$s plugin is installed but not activated.', 'mythemeshop' ), '<a href="https://rankmath.com/wordpress/plugin/seo-suite/" target="_blank">Rank Math SEO</a>' ) . ' @CTA',

			// Add a message in Yoast & AIO metaboxes.
			'show_competitor_notice'  => true,
			'competitor_notice'       =>
				'<span class="dashicons dashicons-lightbulb"></span>
				<span class="mts-ctad-question">' . __( 'Did you know?', 'mythemeshop' ) . ' </span>
				<span class="mts-ctad">' . sprintf( __( 'The new %1$s plugin can make your site load faster, offers more features, and can import your current SEO settings with one click.', 'mythemeshop' ), '<a href="https://rankmath.com/wordpress/plugin/seo-suite/" target="_blank">Rank Math SEO</a>' ) . '</span>' . '@CTA',
		);
	...
	public function dashboard_widget_output( $post, $callback_args ) {
		...
		<div class="rmu-dashboard-panel">
			<a class="rmu-dashboard-panel-close" id="rmu-dashboard-dismiss" href="<?php echo esc_url( add_query_arg( 'rmu-dashboard', '1' ) ); ?>"><?php echo esc_attr( 'Dismiss', 'mythemeshop' ); ?></a>
