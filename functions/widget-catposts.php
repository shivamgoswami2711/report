	...
	?>
		<li class="cat-post-item">
			...
			?>
				...
				<?php $image = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'related'); ?>
<a href='<?php the_permalink(); ?>' title='<?php the_title_attribute(); ?>'><img src="<?php echo $image[0]; ?>" alt="<?php the_title(); ?>"  class="wp-post-image" /></a>
				<?php else: ?>
				<a href='<?php the_permalink(); ?>'><img src="<?php get_template_directory_uri(); ?>/images/smallthumb.png" alt="<?php the_title(); ?>" class="wp-post-image" /></a>
				<?php endif; ?>
			<?php endif; ?>
...
function form($instance) {
	...
	$defaults = array('title' => '','cat' => '','num' => 5,'sort_by' => 'date','asc_sort_order' => '','title_link' => '','comment_num'=>'','date' => '','thumb' => '','thumb_w' => '','thumb_h' => ''  );
...
add_action( 'widgets_init', 'mts_register_single_category_posts_widget' );
function mts_register_single_category_posts_widget(){
